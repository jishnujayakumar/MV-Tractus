...
void code_meta_data(){
  ...
  printf("*     Author1 : Jishnu Jaykumar Padalunkal (https://jishnujayakumar.github.io)            *\n");
  printf("*     Author2 : Praneet Singh [Python-Boost] (https://github.com/praneet195)              *\n");
...
FMV* fmv = createFMVobj(argc,argv);
fmv->connect(true);// Give true to dump_av_format
int i = fmv->get_current_frame_number();
int frame_num=0;
// while(i<10){
